...
If using binary data, consider using an [IDL](https://en.wikipedia.org/wiki/Interface_description_language) such as [ASN.1](019749f9-3d9f-7fe8-8949-61e8c4870cb0) or [Protobuf](https://protobuf.dev/). This allows generating the parsing code.
